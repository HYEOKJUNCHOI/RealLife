...
export const ASSET_SLOTS = [
  ...
  { id: 'character.ahnJungGeun', label: '안중근', category: 'character', defaultPath: '/characters/ahn-jung-geun.png', ratio: 'aspect-square', fallback: '📜' },
  ...
  { id: 'character.choiHyeokjun', label: '최혁준', category: 'character', defaultPath: '/characters/choi-hyeokjun.png', ratio: 'aspect-square', fallback: '👨' },
  { id: 'character.haruna', label: '하루나', category: 'character', defaultPath: '/characters/haruna.png', ratio: 'aspect-square', fallback: '👩' },
  { id: 'character.choiDasol', label: '최다솔', category: 'character', defaultPath: '/characters/choi-dasol.png', ratio: 'aspect-square', fallback: '🧒' },
  { id: 'character.choiDabin', label: '최다빈', category: 'character', defaultPath: '/characters/choi-dabin.png', ratio: 'aspect-square', fallback: '👶' },
  ...
  { id: 'character.zhugeLiang', label: '제갈공명', category: 'character', defaultPath: '/characters/zhuge-liang.png', ratio: 'aspect-square', fallback: '🪭' },
  ...
  { id: 'character.dongZhuo', label: '동탁', category: 'character', defaultPath: '/characters/dong-zhuo.png', ratio: 'aspect-square', fallback: '👑' },
