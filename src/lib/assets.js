...
export const CHARACTER_IMG = {
  ...
  ahnJungGeun: '/characters/ahn-jung-geun.png',
  ...
  choiHyeokjun: '/characters/choi-hyeokjun.png',
  haruna: '/characters/haruna.png',
  choiDasol: '/characters/choi-dasol.png',
  choiDabin: '/characters/choi-dabin.png',
  takedaShingen: '/characters/takeda-shingen.png',
  liuBei: '/characters/liu-bei.png',
  zhugeLiang: '/characters/zhuge-liang.png',
  guanYu: '/characters/guan-yu.png',
  zhangFei: '/characters/zhang-fei.png',
  caoCao: '/characters/cao-cao.png',
  luBu: '/characters/lu-bu.png',
  dongZhuo: '/characters/dong-zhuo.png',
...
export const CHARACTER_META = {
  ...
  ahnJungGeun: { name: '안중근', emoji: '📜', desc: '독립운동가' },
  ...
  choiHyeokjun: { name: '최혁준', emoji: '👨', desc: '아빠' },
  haruna: { name: '하루나', emoji: '👩', desc: '엄마' },
  choiDasol: { name: '최다솔', emoji: '🧒', desc: '6살 남자아이' },
  choiDabin: { name: '최다빈', emoji: '👶', desc: '1살 남자아이' },
  takedaShingen: { name: '다케다 신겐', emoji: '🪭', desc: '전국시대 군략가' },
  liuBei: { name: '유비', emoji: '👑', desc: '삼국지 군주' },
  zhugeLiang: { name: '제갈공명', emoji: '🪭', desc: '삼국지 책략가' },
  ...
  dongZhuo: { name: '동탁', emoji: '👑', desc: '삼국지 군벌' },
